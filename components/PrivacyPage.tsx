            ...
            <section className="max-w-4xl mx-auto px-6 py-24 md:py-32">
                ...
                <div className="space-y-16 font-sans text-gray-600 font-light leading-relaxed text-lg">
                    ...
                    <div>
                        ...
                        <p>
                            If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information, contact our Privacy Compliance Officer at <a href="mailto:support@eyira.shop" className="text-black border-b border-black pb-0.5 hover:opacity-50">support@eyira.shop</a>.
                        </p>
                    </div>
                </div>
            </section>
