  ...
  return (
    <section id="concierge" className="py-40 px-6 md:px-12 bg-[#FAFAFA] border-y border-gray-100 scroll-mt-24">
      <div className="max-w-4xl mx-auto text-center">
        <span className="font-sans text-[11px] tracking-[0.4em] text-gray-400 block mb-10 uppercase font-medium">Pantry Recipe Generator</span>
        <h3 className="font-serif text-4xl md:text-6xl text-black mb-10 font-medium leading-tight tracking-tight">
          What's in <br />
          <span className="italic font-normal text-gray-400">your fridge?</span>
        </h3>
        <p className="font-sans text-eyira-grey font-light text-base md:text-lg mb-16 max-w-xl mx-auto leading-relaxed">
          Got chicken? Pasta? A lonely bag of frozen shrimp? Tell us what ingredients you have, and we’ll tell you how to turn them into a meal with Eyira Base.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mb-20 relative max-w-2xl mx-auto">
          <input
            ...
            placeholder="e.g. Leftover rice, ground beef, frozen spinach..."
          ...
          >
            {loading ? 'Consulting Chef...' : 'Create Recipe'}
          </button>
        </form>
        ...
        {response && (
          <div className="p-12 md:p-16 bg-white border border-gray-100 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-1000 text-left">
            <span className="font-sans text-[10px] tracking-[0.3em] text-gray-400 block mb-8 uppercase font-medium">From Your Kitchen</span>
