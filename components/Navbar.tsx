...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-700 top-7 ${scrolled ? 'py-4 bg-white/90 backdrop-blur-md border-b border-gray-100' : 'py-8 md:py-12 bg-transparent'}`}>
